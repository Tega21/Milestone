...
public class FileService {
     ...
     */
    public synchronized List<SalableProduct> readInventoryFromFile() throws IOException {
     ...
     */
    public synchronized void writeInventoryToFile(List<SalableProduct> products) throws IOException {
